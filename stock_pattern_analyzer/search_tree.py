...
class SearchTree:
    ...
    def search_most_recent(self, ticker: str, k: int = 5) -> tuple:
        if ticker not in self._data_holder.tickers:
            raise ValueError("Searched ticker is not in the list of downloaded ticker data")
